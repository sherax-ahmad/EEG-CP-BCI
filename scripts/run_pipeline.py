...
def run_single_subject(
    ...
    # YAML may load scientific notation (e.g. 150e-6) as a string — cast to float
    raw_reject = ep_cfg.get("reject_peak_to_peak", 150e-6)
    reject_peak_to_peak = float(raw_reject) if raw_reject is not None else None
